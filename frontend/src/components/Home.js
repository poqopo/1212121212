...
const Home = () => {
    return(
        <div className='home'>
            ...
            <br></br>
            <br></br>
            <h2 className='wemadefuture' style={{fontFamily:'WMF'}}>WE MADE FUTURE</h2>
            <br></br>
