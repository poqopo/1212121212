...
const WUSD_WETH = artifacts.require('UniswapPairOracle_WUSD_WETH')
const MDAI_WETH = artifacts.require('UniswapPairOracle_MDAI_WETH')

const Owner_Address = "0xe7f890A0CB4c0Cbd68848F26F0998562502323Dc"
const Collateral_Address = "0x0feB3a8702F4943aA3e502369fEda55258f1a018"
...
//  const we_made_future = await We_Made_Future.deployed()
  ...
  await deployer.deploy(WUSDPool, "0xB7FB1bb06a10f7Ec53CaC0Bf29d7d7c058A47dE8", "0x040d87e9A4f44dF98b67C60B47515019975E7ad7", "0x0feB3a8702F4943aA3e502369fEda55258f1a018", Owner_Address)
...
//  await deployer.deploy(ChainlinkETHUSDPriceConsumer)
  await deployer.deploy(WMF_WETH, "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f", "0x040d87e9A4f44dF98b67C60B47515019975E7ad7", "0xc778417E063141139Fce010982780140Aa0cD5Ab", "0xe7f890A0CB4c0Cbd68848F26F0998562502323Dc")
  await deployer.deploy(WUSD_WETH, "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f", "0xB7FB1bb06a10f7Ec53CaC0Bf29d7d7c058A47dE8", "0xc778417E063141139Fce010982780140Aa0cD5Ab", "0xe7f890A0CB4c0Cbd68848F26F0998562502323Dc")
  await deployer.deploy(MDAI_WETH, "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f", "0x0feB3a8702F4943aA3e502369fEda55258f1a018", "0xc778417E063141139Fce010982780140Aa0cD5Ab", "0xe7f890A0CB4c0Cbd68848F26F0998562502323Dc")
